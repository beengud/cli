...
```bash
observe datastream list --name "Kubernetes Explorer"
observe datastream list --name "Tracing"
observe datastream list --name "Metrics/OpenTelemetry"
observe datastream list --name "Observe Agent"
```
