 ...
 * closed `type` enum and, on OutOfAcceleratedRange, the acceleratedFrom
 * recovery timestamp.
 * 
 * @export
 * @interface ApmError
...
/**
 * One queryable metric on Service.related.metrics. attributeMapping maps
 * each Service field name to one or more dimension names in this metric's
 * dataset.
 * 
 * @export
...
/**
 * Per-row correlation hints on Service. Always present; values may be
 * empty. correlationTags maps Service field name to OTel/system attribute
 * keys; metrics is the discovery list of related queryable metrics.
 * 
 * @export
...
/**
 * Role of a service-keyed row. PascalCase per style guide.
 * @export
 * @enum {string}
 */
